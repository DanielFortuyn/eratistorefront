...
```sh
grep -rl 'eratistorefront' ./ | xargs sed -i '' 's/eratistorefront/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with eratistorefront
...
Want to contribute? Ping us on `eratistorefront` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/eratistorefront.git
    cd eratistorefront
    ```
...
- [eratistorefront integration Documentation](https://docs.vuestorefront.io/eratistorefront)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `eratistorefront` channel on [our Discord](discord.vuestorefront.io).
